...
const NewMapSection = () => {
  ...
  const onViewportChange = ({width, height, ...etc}) => {
    setViewport({...etc})
  }
        ...
        >
          <svg style={{ transform: 'translate(-50%,-50%)' }} width="51" height="48" viewBox="0 0 51 48" fill="#C84A48">
            ...
            <path fillRule="evenodd" clipRule="evenodd"
                  d="M51 18.3382L33.3665 15.8022L25.4922 0L17.6101 15.8022L0 18.3382L12.7422 30.6253L9.72023 48L25.4766 39.7983L41.233 47.9923L38.2188 30.6331L51 18.3382ZM39.87 46.0883L25.4922 38.6189L11.1378 46.0883L13.8794 30.2553L2.2665 19.0628L18.3111 16.7503L25.4922 2.35105L32.6655 16.7503L48.7101 19.0628L37.0973 30.2708L39.87 46.0883Z"/>
          </svg>
        </Marker>
      </ReactMapGL>
    </section>
